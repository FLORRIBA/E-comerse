const productStart = [
  ...
  },
  {
    ...
    active: true,
    descripcion:
      "<strong>Shampoo</strong> sólido y jabon vegetal de avena y almendras. <strong>Pasta</strong> dental natural: tiene todo lo necesario para la correcta limpieza bucal de un niño. <strong>Cepillo </strong>de dientes de bambú: packaging de cartón y mango de bambú moso.",
  ...
  },
  {
    ...
    active: true,
    descripcion:
      "Está elaborado con materias primas que tienen la capacidad de biodegradarse en la naturaleza en muy poco tiempo. Desengrasa igual o mejor que muchos de los productos convencionales. <strong> Cuida tu piel y el medio ambiente.",
    fecha: new Date("2023-04-15").getTime(),
